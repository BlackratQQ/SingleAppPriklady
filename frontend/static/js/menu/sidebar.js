class verticalmenu extends HTMLElement {
  ...
  <div class="side-bar">
    ...
    <div class="menu">
      <div class="item">
        <a href="/" data-link> 
        Home <i class="fas fa-home dropdown"></i></a>
      </div>
      <div class="item">
        <a class="sub-btn">
          Matice
      ...
      <div class="item">
        <a href="/body-nespojitosti" data-link> Body nespojitosti </a>
      </div>
      <div class="item">
        <a href="/asymptoty-funkce" data-link> Asymptoty funkce </a>
      </div>
      <div class="item">
        <a class="sub-btn">
          Derivace
      ...
      <div class="item">
        <a href="/tecny-a-normaly" data-link> Tečny a normály </a>
      </div>
      <div class="item">
        <a href="/tayloruv-polynom" data-link> Taylorův polynom </a>
      </div>
      <div class="item">
      ...
      <div class="item">
        <a href="/zakrivenost-a-inflexni-body" data-link>
